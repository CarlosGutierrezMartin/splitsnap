...
interface AuthViewProps {
    ...
    onSignUpEmail: (email: string, pass: string, displayName: string) => Promise<void>;
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            if (mode === 'LOGIN') {
                ...
                await onSignUpEmail(email, password, displayName.trim());
            }
        } catch (err) {
            // Error is handled by parent/hook state
        }
    };
                ...
                <div className="p-8">
                    <div className="text-center mb-8">
                        ...
                        <p className="text-gray-500">
                            {mode === 'LOGIN' ? 'Welcome back! Sign in to continue.' : 'Create an account to save your sessions.'}
                        </p>
                    </div>
                    ...
                    <div className="mt-4">
                        <button
                            ...
                            disabled={loading}
                            className="w-full flex items-center justify-center gap-2 bg-white border border-gray-200 text-gray-700 font-semibold py-3 px-4 rounded-xl hover:bg-gray-50 focus:ring-2 focus:ring-gray-200 transition-all"
                        >
                    ...
                    <div className="mt-6 flex flex-col items-center space-y-4">
                        ...
                        <button
                            onClick={handleGuest}
                            type="button"
                            className="flex items-center gap-2 text-gray-500 hover:text-gray-700 font-medium transition-colors group"
                        >
